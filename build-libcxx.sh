...
for arch in $ARCHS; do
    ...
    cmake \
        ...
        -DCMAKE_C_FLAGS_INIT="$CFGUARD_CFLAGS $EXTRA_CFLAGS $PTHREAD_INC" \
        -DCMAKE_CXX_FLAGS_INIT="$CFGUARD_CFLAGS $EXTRA_CFLAGS $PTHREAD_INC -D_LIBUNWIND_HAS_THREAD_API_PTHREAD" \
        ..
